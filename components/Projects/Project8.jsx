        ...
        <section className="flex flex-col md:flex-row-reverse w-full min-h-screen bg-white">
            ...
            <div className="w-full md:w-[30%] flex flex-col justify-center items-center px-6 md:px-12 py-10 md:py-0 text-center">
                ...
                <p className="mt-4 text-lg md:text-xl font-light leading-relaxed text-black">
                   The Twin Gables project, spanning 14,000 sq.ft, is a study in symmetry and sophistication. With construction at the woodwork stage, Emphasis Architects brings together classic gabled silhouettes and contemporary sensibilities to create a home that is both iconic and welcoming.
                </p>
