    ...
    return (
        <section className="flex flex-col md:flex-row-reverse w-full min-h-screen bg-white">
            ...
            <div className="w-full md:w-[30%] flex flex-col justify-center items-center px-6 md:px-12 py-10 md:py-0 text-center">
                <h2 className="text-3xl md:text-4xl md:font-medium tracking-widest text-black">THE GRID HOUSE</h2>
                <p className="mt-4 text-lg md:text-xl font-light leading-relaxed text-black">
                   Currently at the ceiling stage, this 5,000 sq.ft residence is designed to maximize light, flow, and connection, embodying Emphasis Architects’ pursuit of environments that nurture both function and beauty.
                </p>
