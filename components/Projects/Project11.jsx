    ...
    return (
        <section className="flex flex-col md:flex-row w-full min-h-screen bg-white">
            ...
            <div className="w-full md:w-[30%] flex flex-col justify-center items-center px-6 md:px-12 py-10 md:py-0 text-center">
                <h2 className="text-3xl md:text-4xl md:font-medium tracking-widest text-black uppercase">casa flora</h2>
                <p className="mt-4 text-lg md:text-xl font-light leading-relaxed text-black">
                    This project is conceived as a harmonious blend of geometric clarity and organic inspiration, setting the stage for a living experience that is both innovative and deeply rooted in nature.
                </p>
