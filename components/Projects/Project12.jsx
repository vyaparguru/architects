...
export default function Project12() {
    return (
        <section className="flex flex-col md:flex-row-reverse w-full min-h-screen bg-white">
            {/* Image Section */}
            <div className="w-full md:w-[70%] aspect-[3/2] h-auto md:h-auto relative">
                <Image
                    src="/projects/12.jpg"
                    alt="shiv-jyoti-public-school"
                    fill
            ...
            <div className="w-full md:w-[30%] flex flex-col justify-center items-center px-6 md:px-12 py-10 md:py-0 text-center">
                <h2 className="text-3xl md:text-4xl md:font-medium tracking-widest text-black uppercase">Shiv Jyoti Public School</h2>
                <p className="mt-4 text-lg md:text-xl font-light leading-relaxed text-black">
                   Emphasis Architects infuses this project with a sense of grandeur and comfort, ensuring every space is tailored to inspire and delight.
                </p>
                <div className="flex gap-8 mt-1 md:mt-6 text-black justify-center">
                    <div>
                        <div className="text-md font-extrabold">Size</div>
                        <div className="text-md">NA</div>
                    </div>
                    <div>
                        <div className="text-md font-extrabold">Year Completed</div>
                        <div className="text-md">2025</div>
                    </div>
                </div>
                <Link href="/projects/shiv-jyoti-public-school" className="mt-6 text-black w-fit">
