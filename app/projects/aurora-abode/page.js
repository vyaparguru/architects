    ...
    return (
        <>
            ...
            <ProjectDetails
                ...
                size="9000 sq.ft"
                year="2024"
                intro="At Emphasis, the journey from vision to reality is as meticulously crafted as the blueprint itself. The Harminder Singh Residence, nestled in the quiet elegance of Ramneek Avenue, showcases our commitment to detail and delivery across every phase of execution. 
...
"
                descriptionBlocks={[
                    "Interior Drawings & Finishing Touches: Our interior drawing set was not just a technical roadmap but a design narrative — each elevation, joinery detail, and material specification was designed to reflect the calm elegance the client envisioned. Every built-in was detailed with layered drawings, including exact edge profiles, handle cutouts, and electrical routing. Special attention was given to ceiling integrations and lighting troughs to enhance the ambience with hidden lighting and subtle highlights. Wall finishes, window detailing, and floor junctions were coordinated down to the millimeter.",
